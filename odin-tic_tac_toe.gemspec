...
require_relative 'lib/odin/tic_tac_toe/version'

Gem::Specification.new do |spec|
  spec.name = 'odin-tic_tac_toe'
  spec.version = Odin::TicTacToe::VERSION
  spec.authors = ['James Couball']
  spec.email = ['jcouball@yahoo.com']

  spec.summary = 'A Tic Tac Toe game'
  spec.description = <<~DESCRIPTION
    A tic-tac-toe game on the command line where two human players can play against each other.
  DESCRIPTION
  spec.homepage = 'https://github.com/jcouball/odin-tic_tac_toe'
  spec.license = 'MIT'
